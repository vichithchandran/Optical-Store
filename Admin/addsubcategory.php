...
<form action="/action_page.php" method="post">
  <div class="container1">
   ...
   <select name="selectcat" placeholder="Select Category" Style="width: 100%;padding: 12px 20px; margin: 8px 0; display: inline-block; border: 1px solid #ccc;box-sizing: border-box;" required>
    ...
    <input type="Text" placeholder="Enter Sub Category" name="subcategory" required>
